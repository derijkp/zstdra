...
# This script builds zstdra and zstdindex using the Holy build box environment
# If you give the parameter 32, a 32bit build will be made
# It expects a build zstd library in zstd-ori/zstd-1.3.8, which can be made using the 
# hbb_make_zstd.hs script
...
echo "building zstdra in bin$ARCH"
...
echo "Finished building zstdra and zstdindex"
